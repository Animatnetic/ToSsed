...
async def summarize_input():
    if request.method == "POST":
        ...
        if text_input == "" or text_input is None:
            ...
            all_results = []
            all_summary_titles = [] # Array for the summary to be considered by Falcon-180b to give a grading based on the titles of the most major/important points of the summarised ToS.
